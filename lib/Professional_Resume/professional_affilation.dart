...
class ProfessionalAfflication extends StatelessWidget {
  const ProfessionalAfflication({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      children: [
                        ...
                        Align(
                          alignment: Alignment.topLeft,
                          child: Text(
                            'Goverment College University FSD',
                            style: TextStyle(
                              color: Colors.white,
                            ),
                          ),
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: TextFormField(
                  ...
                  autofocus: true,
                  decoration: InputDecoration(
                      hintText: "Desicription Of Affliation",
                      hintStyle: TextStyle(fontSize: 15.0, color: Colors.white),
                      labelStyle: TextStyle(color: Colors.white),
                      contentPadding: EdgeInsets.only(left: 5),
                      focusedBorder: InputBorder.none,
