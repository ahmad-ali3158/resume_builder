...
class ConferenceAttendence extends StatelessWidget {
  const ConferenceAttendence({Key? key}) : super(key: key);
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: TextFormField(
                  ...
                  autofocus: true,
                  decoration: InputDecoration(
                      hintText: "Desicription Of Conference",
                      hintStyle: TextStyle(fontSize: 15.0, color: Colors.white),
                      labelStyle: TextStyle(color: Colors.white),
                      contentPadding: EdgeInsets.only(left: 5),
                      focusedBorder: InputBorder.none,
